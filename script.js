...
function getWeatherData(searchCity) {
    ...
    var cordsURL = "https://api.opencagedata.com/geocode/v1/json?q=" + searchCity + "&key=9af035f8b82643ff8b99924830b068c8&limit=1";
    ...
    $.ajax({
        ...
        var weatherURL = "https://api.openweathermap.org/data/2.5/onecall?lat=" + lat + "&lon=" + long + "&appid=3458b608d66bb8c55896586dd8fbf11b"
